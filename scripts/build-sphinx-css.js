...
/* Content area - light theme for readability.
   Widen from RTD default (800px) so data-rich tables are not clipped.
...
/* sphinx-needs DataTables layout fixes
   -------------------------------------------------------------------------
   sphinx-needs initialises DataTables with autoWidth:false, which locks
   the <table> to a narrow pixel width.  Force it to fill its container. */
table.NEEDS_DATATABLES {
    width: 100% !important;
}

/* DataTables toolbar uses CSS floats.  Without clearing, the
   .wy-table-responsive wrapper renders beside the toolbar instead
   of below it, stealing hundreds of pixels from table width. */
.dataTables_wrapper .wy-table-responsive {
    clear: both;
}
...
body.has-version-sub-bar .site-nav-bar {
...
/* Collapsed state */
html.sidebar-collapsed .wy-nav-side {
    transform: translateX(-100%);
}

html.sidebar-collapsed .wy-nav-content-wrap {
    margin-left: 0;
}
