...
/* Assign explicit order to each project */
.wy-menu-vertical li.toctree-l1:has(> a[href*="transfer"]) {
    order: 1;
}

.wy-menu-vertical li.toctree-l1:has(> a[href*="deploy"]) {
    order: 2;
}

.wy-menu-vertical li.toctree-l1:has(> a[href*="whisper"]) {
    order: 3;
}
